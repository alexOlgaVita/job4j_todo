...
class TaskRepositoryTest {
    ...
    public void whenCreateThenGetSame() {
        var task = new Task(null, "Кино", "Сходить в кино с друзьями", getLocalDateTimeFromString(date1), true);
    ...
    public void whenCreateSeveralThenGetAll() {
        var task1 = taskRepository.create(new Task(null, "Кино", "Сходить в кино с друзьями", getLocalDateTimeFromString(date1), true));
        var task2 = taskRepository.create(new Task(null, "Чай", "Купить крепкий чай", getLocalDateTimeFromString(date1), true));
        var task3 = taskRepository.create(new Task(null, "Английский", "Выполнить задание по английскомй", getLocalDateTimeFromString(date1), true));
    ...
    public void whenCreateSeveralThenGetAllDone() {
        var task1 = taskRepository.create(new Task(null, "Кино", "Сходить в кино с друзьями", getLocalDateTimeFromString(date1), true));
        var task2 = taskRepository.create(new Task(null, "Чай", "Купить крепкий чай", getLocalDateTimeFromString(date1), false));
        var task3 = taskRepository.create(new Task(null, "Английский", "Выполнить задание по английскомй", getLocalDateTimeFromString(date1), true));
    ...
    public void whenCreateSeveralThenGetAllNew() {
        var task1 = taskRepository.create(new Task(null, "Кино", "Сходить в кино с друзьями", getLocalDateTimeFromString(date1), false));
        var task2 = taskRepository.create(new Task(null, "Чай", "Купить крепкий чай", getLocalDateTimeFromString(date1), true));
        var task3 = taskRepository.create(new Task(null, "Английский", "Выполнить задание по английскомй", getLocalDateTimeFromString(date1), false));
    ...
    public void whenUpdateTaskWithoutCreatedDoneIsSuccessfully() {
        Task task = new Task(null, "Кино", "Сходить в кино с друзьями", getLocalDateTimeFromString(date1), true);
    ...
    public void whenSetDoneWhenNotDoneIsSuccessfully() {
        Task task = new Task(null, "Кино", "Сходить в кино с друзьями", getLocalDateTimeFromString(date1), false);
        Task taskSaved = taskRepository.create(task);
